...
#if variable "ARG_CNT" is greater than integer "1" , print "Usage: tail.py <file>"
print(tail(TEXT))
#execute "tail" function on the argument "TEXT" and print the return from the function